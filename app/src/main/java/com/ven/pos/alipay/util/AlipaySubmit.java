...
public class AlipaySubmit {
	...
	private static Map<String, String> buildRequestPara(
		...
		sParaTemp
				.put("sign_type", GlobalContant.instance().aliConfig.sign_type);
		Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);

		// sPara.put("version", "1.0");
		// 生成签名结果
	...
	public static String buildRequest(String strParaFileName,
		...
		// request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+GlobalContant.instance().aliConfig.input_charset);
		request.setUrl(GlobalContant.instance().aliConfig.ALIPAY_GATEWAY);

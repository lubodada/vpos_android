...
public class PaymentResultActivity extends BaseActivity {
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        isLandScreen = su.getPrefboolean(PaymentResultActivity.this, "isLandScreen", false);
        if (isLandScreen)
        ...
        try {
            if (device == null) {
                device = (PrinterDevice) POSTerminal.getInstance(PaymentResultActivity.this)
                        ...
                        if (Build.MANUFACTURER.contains("BASEWIN")
                            ...
                            try {
                                if (device.queryStatus() == PrinterDevice.STATUS_OUT_OF_PAPER) {
                                    ...
                                    Print_HuiYinPos pthy = new Print_HuiYinPos();
                                    pthy.prilay(PaymentResultActivity.this, orderId,
                                            monery, paycode, PaymentMethod, shanghm,
                                            clientId, Time);
                                }
                            } catch (Exception ex) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 7:
                    ...
                    pay_notice_money_tv.setText(Double.toString(Double.parseDouble(str_monery) / 100));
                    ...
                    if (Build.MANUFACTURER.contains("BASEWIN")
                        ...
                        try {
                            if (device.queryStatus() == PrinterDevice.STATUS_OUT_OF_PAPER) {
                                ...
                                pthy.prilay(PaymentResultActivity.this, order, Double
                                                .toString(Double.parseDouble(str_monery) / 100),
                                        result_r, Paymode(PaymentMethod), cashierName,
                                        clientId, Time_new);
                            }

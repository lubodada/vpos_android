...
public class WxPayQuery extends PayQueryBase {
...
//
//	public void QueryPay(String tradeNo, String totalMoney, String payDetails, int oper) {
//		outTradNo = tradeNo;
//		nTotalFee = totalMoney;
//		currentPayDetails = payDetails;
//		this.oper = oper;
//		if (null == queryPayThread) {
//			queryPayThread = new QueryPayThread(tradeNo);
//			queryPayThread.start();
//		} 
//	}

//	public void ModifyPayInfo(String tradeNo, String totalMoney, String payDetails, int oper) {
//		outTradNo = tradeNo;
//		nTotalFee = totalMoney;
//		currentPayDetails = payDetails;
//		this.oper = oper;
...
//	private void ShowResult(boolean bResult, String strErrorMsg,
//			String strPayMoney, String strTradeNo, int nPayType,
//			String strPayTime) {
//		
////		String currentActivityName = UtilTool.getCurrentActivityName(parentContext);
////		if(!currentActivityName.equals(parentContext.getClass().getName())){
////			return;
////		}
////		
...
//		localIntent.putExtra(PaymentResultActivity.IntentPayDetails, currentPayDetails);

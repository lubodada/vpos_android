...
public class LoginActivity extends BaseActivity implements OnClickListener {
    ...
    // 升级相关
    String result;
    boolean force_update, isLandScreen;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name.contains("BASEWIN") || name.contains("basewin") || name.contains("WIZAR") || name.contains("wizar") || ReflectUtil.getWizarType()) {
        ...
        isLandScreen = su.getPrefboolean(LoginActivity.this, "isLandScreen", false);

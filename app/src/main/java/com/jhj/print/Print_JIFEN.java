...
public class Print_JIFEN {
	 ...
	 * @Time 时间
	 * */
	public void prilay(Context context, String orderId, String number,
		...
		new_print(context, orderId, cashiername, number, PaymentMethod,
				clientId, Time);
	...
	public void new_print(Context context, String orderId, String cashiername,
			String number, String PaymentMethod, String merchantnum, String Time) {
